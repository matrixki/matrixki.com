...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {
      ...
      this.isMounted && window.addEventListener('scroll', this.handleHeaderBackground);
    ...
    value: function componentWillUnmount() {
      this.typed.destroy();
      this._isMounted = false; // this.handleHeaderBackground = false;
...
//# sourceMappingURL=4.730adffce9bf916b92a8.hot-update.js.map