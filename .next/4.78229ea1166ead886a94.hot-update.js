...
function (_React$Component) {
  ...
  function Header(props) {
    ...
    _this = _possibleConstructorReturn(this, (Header.__proto__ || Object.getPrototypeOf(Header)).call(this, props)); // let isHome = this.props.router.pathname==='/';
  ...
  _createClass(Header, [{
    ...
    value: function componentDidMount() {// window.addEventListener('scroll', this.handleHeaderBackground);
...
//# sourceMappingURL=4.78229ea1166ead886a94.hot-update.js.map